                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="NamaProduct" value="{$Data.NamaProduct}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="DeskripsiProduct" rows="3" required>{$Data.DeskripsiProduct}</textarea>
                            </div>
                        </div>
