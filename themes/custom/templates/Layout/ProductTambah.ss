                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" name="GambarProduct[]" accept="image/*" multiple required>
                            </div>
                        </div>  
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <% loop $Warna %>
                                    <div class="col-md-3 my-1">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input checkbox-harga" type="checkbox" name="WarnaProduct[]" id="WarnaProduct{$ID}" value="{$ID}" data-id="{$ID}">
                                            <label class="form-check-label mt-1" for="WarnaProduct{$ID}">{$NamaWarna}</label>
                                        </div>
                                    </div>
                                    <div class="col-md-2 my-1">
                                        <input class="form-control" id="JumlahProduct{$ID}" type="number" name="Jumlah[]" disabled required>
                                    </div>
                                    <div class="col-md-7 my-1">
                                        <div class="input-group">
                                            <span class="input-group-text text-body">Rp.</span>
                                            <input type="text" id="HargaProduct{$ID}" class="form-control uang" name="Harga[]" disabled required>
                                        </div>
                                    </div>
                                <% end_loop %>
                            </div>
