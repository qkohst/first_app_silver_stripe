      ...
      <div class="card card-carousel overflow-hidden h-100 p-0">
        <div id="carouselExampleCaptions" class="carousel slide h-100" data-bs-ride="carousel">
          <div class="carousel-inner border-radius-lg h-100">
            <div class="carousel-item h-100 active" style="background-image: url('{$BaseHref}public/assets/GambarProduct/{$Data.Gambar.last.NamaGambar}'); background-size: cover;">
            </div>
          </div>
                    ...
                    <tbody>
                        <% loop $Data.Warnaproduct %>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    <span class="badge badge-sm bg-gradient-info">Rp. <span class="uang">{$HargaProduct.last.Harga}</span></span>
                                </td>
